...
**Preprint v0.3.** Paper D in the series on clique partitions in split and chordal graphs. This is a public preprint in the four-paper Erdős #81 chordal sequence.
...
| Local chordal toolkit | Paper B | public preprint v0.3 |
| Fractional chordal theorem | Paper C | public preprint v0.3, using Paper B as dependency |
