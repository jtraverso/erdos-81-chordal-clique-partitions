...
\date{Preprint v0.3 --- June 30, 2026}
...
\begin{center}
{\small Paper D in the series on clique partitions in split and chordal graphs. Preprint v0.3.}
\end{center}
...
\[
    ...
    \left(\frac16+o(1)\right)n^2.
\]
This preprint contains the short final rounding and sharpness step of the series.
\end{abstract}
...
This preprint is the final step in the series. Paper A proves the sharp split graph theorem. Paper B develops the local and structural chordal toolkit. Paper C proves the fractional chordal theorem
\[
    |E(G)|-2\nu_3^*(G)
    \le
    \left(\frac16+o(1)\right)n^2.
...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \textbf{Presentation choice.} Paper D may ultimately remain standalone or be merged into Paper C as the final rounding section.
\end{enumerate}
